...
create table CustomerDetails( Customer_ID int primary key, 
Client_ID int,
FatherName char(225),
MotherName char(225),
Amount bigint,
...
Dates date,
Times time,
Constraint FK_Client_ID FOREIGN KEY(Client_ID) references CustomersHeader(Client_ID))
